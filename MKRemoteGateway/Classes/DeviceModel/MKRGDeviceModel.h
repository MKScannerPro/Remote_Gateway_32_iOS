...
typedef NS_ENUM(NSInteger, MKRGDeviceModelState) {
    MKRGDeviceModelStateOffline,
    MKRGDeviceModelStateOnline,
};

//当设备离线的时候发出通知
extern NSString *const MKRGDeviceModelOfflineNotification;

@protocol MKRGDeviceModelDelegate <NSObject>
...
@interface MKRGDeviceModel : NSObject<MKRGDeviceModeManagerDataProtocol>
...
/**
 设备的状态，离线、在线
 */
@property (nonatomic, assign)MKRGDeviceModelState onLineState;

#pragma mark - 业务流程相关

@property (nonatomic, weak)id <MKRGDeviceModelDelegate>delegate;
