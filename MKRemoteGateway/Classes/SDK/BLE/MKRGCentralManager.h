...
extern NSString *const mk_rg_peripheralConnectStateChangedNotification;

//Notification of changes in the status of the Bluetooth Center.
extern NSString *const mk_rg_centralManagerStateChangedNotification;
 ...
 */
extern NSString *const mk_rg_deviceDisconnectTypeNotification;

@class CBCentralManager,CBPeripheral;
@class MKRGOperation;

@interface MKRGCentralManager : NSObject<MKBLEBaseCentralManagerProtocol>

@property (nonatomic, weak)id <mk_rg_centralManagerScanDelegate>delegate;

/// Current connection status
@property (nonatomic, assign, readonly)mk_rg_centralConnectStatus connectStatus;
