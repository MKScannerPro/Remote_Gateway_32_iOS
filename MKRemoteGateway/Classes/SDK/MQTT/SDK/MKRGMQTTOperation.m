...
/**
 线程ID
 */
@property (nonatomic, assign)mk_rg_serverOperationID operationID;
...
@implementation MKRGMQTTOperation
@synthesize executing = _executing;
@synthesize finished = _finished;

- (void)dealloc{
    NSLog(@"MKRGMQTTOperation销毁");
}
...
#pragma mark - MKRGMQTTOperationProtocol
...
- (void)didReceiveMessage:(NSDictionary *)data onTopic:(NSString *)topic {
    ...
    [self dataParserReceivedData:[MKRGMQTTTaskAdopter parseDataWithJson:data topic:topic]];
}
...
- (void)dataParserReceivedData:(NSDictionary *)dataDic{
    ...
    mk_rg_serverOperationID operationID = [dataDic[@"operationID"] integerValue];
    if (operationID == mk_rg_defaultServerOperationID || operationID != self.operationID) {
        return;
    }
