...
static NSString *const fileName = @"MKRGServerParams.txt";

@interface MKRGServerParamsModel ()
...
@implementation MKRGServerParamsModel
...
- (BOOL)checkServerDataProtocol:(id <MKRGServerParamsProtocol>)protocol {
