//
//  MKRGMqttServerConfigFooterView.h
...
@interface MKRGMqttServerConfigFooterViewModel : NSObject
...
@protocol MKRGMqttServerConfigFooterViewDelegate <NSObject>
...
@interface MKRGMqttServerConfigFooterView : UIView

@property (nonatomic, strong)MKRGMqttServerConfigFooterViewModel *dataModel;

@property (nonatomic, weak)id <MKRGMqttServerConfigFooterViewDelegate>delegate;
