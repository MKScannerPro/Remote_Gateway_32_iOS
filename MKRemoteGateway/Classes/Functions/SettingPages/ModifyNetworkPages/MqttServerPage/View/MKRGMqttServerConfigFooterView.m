//
//  MKRGMqttServerConfigFooterView.m
...
@implementation MKRGMqttServerConfigFooterViewModel
@end
...
MKRGMqttServerSSLViewDelegate,
MKRGMqttServerSettingViewDelegate,
MKRGMqttServerLwtViewDelegate>
...
@property (nonatomic, strong)MKRGMqttServerSSLView *sslView;

@property (nonatomic, strong)MKRGMqttServerLwtView *lwtView;

@property (nonatomic, strong)MKRGMqttServerSettingView *settingView;

@property (nonatomic, assign)NSInteger index;

@end

@implementation MKRGMqttServerConfigFooterView
...
#pragma mark - MKRGMqttServerSSLViewDelegate
...
#pragma mark - MKRGMqttServerSettingViewDelegate
...
#pragma mark - MKRGMqttServerLwtViewDelegate
...
#pragma mark - setter
- (void)setDataModel:(MKRGMqttServerConfigFooterViewModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKRGMqttServerConfigFooterViewModel.class]) {
        return;
    }
    ...
    MKRGMqttServerSSLViewModel *sslModel = [[MKRGMqttServerSSLViewModel alloc] init];
    ...
    MKRGMqttServerLwtViewModel *lwtModel = [[MKRGMqttServerLwtViewModel alloc] init];
...
- (MKRGMqttServerSSLView *)sslView {
    if (!_sslView) {
        _sslView = [[MKRGMqttServerSSLView alloc] init];
...
- (MKRGMqttServerLwtView *)lwtView {
    if (!_lwtView) {
        _lwtView = [[MKRGMqttServerLwtView alloc] init];
...
- (MKRGMqttServerSettingView *)settingView {
    if (!_settingView) {
        _settingView = [[MKRGMqttServerSettingView alloc] init];
