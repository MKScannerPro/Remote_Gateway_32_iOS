...
@implementation MKRGMqttServerLwtViewModel
@end

@interface MKRGMqttServerLwtView ()
...
@implementation MKRGMqttServerLwtView
...
- (void)lwtButtonPressed {
    ...
    UIImage *lwtIcon = (self.lwtButton.selected ? LOADICON(@"MKRemoteGateway", @"MKRGMqttServerLwtView", @"rg_switchSelectedIcon.png") : LOADICON(@"MKRemoteGateway", @"MKRGMqttServerLwtView", @"rg_switchUnselectedIcon.png"));
...
- (void)retainButtonPressed {
    ...
    UIImage *retainIcon = (self.retainButton.selected ? LOADICON(@"MKRemoteGateway", @"MKRGMqttServerLwtView", @"rg_switchSelectedIcon.png") : LOADICON(@"MKRemoteGateway", @"MKRGMqttServerLwtView", @"rg_switchUnselectedIcon.png"));
...
#pragma mark - setter
- (void)setDataModel:(MKRGMqttServerLwtViewModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKRGMqttServerLwtViewModel.class]) {
        return;
    }
...
- (UIButton *)lwtButton {
    if (!_lwtButton) {
        ...
        [_lwtButton setImage:LOADICON(@"MKRemoteGateway", @"MKRGMqttServerLwtView", @"rg_switchUnselectedIcon.png") forState:UIControlStateNormal];
...
- (UIButton *)retainButton {
    if (!_retainButton) {
        ...
        [_retainButton setImage:LOADICON(@"MKRemoteGateway", @"MKRGMqttServerLwtView", @"rg_switchUnselectedIcon.png") forState:UIControlStateNormal];
