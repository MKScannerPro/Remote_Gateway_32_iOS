//
//  MKRGMqttNetworkSettingsModel.m
...
@interface MKRGMqttNetworkSettingsModel ()
...
@implementation MKRGMqttNetworkSettingsModel
...
- (BOOL)readNetworkInfos {
    ...
    [MKRGMQTTInterface rg_readNetworkInfosWithMacAddress:[MKRGDeviceModeManager shared].macAddress topic:[MKRGDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configNetworkInfos {
    __block BOOL success = NO;
    [MKRGMQTTInterface rg_modifyNetworkInfos:self macAddress:[MKRGDeviceModeManager shared].macAddress topic:[MKRGDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
