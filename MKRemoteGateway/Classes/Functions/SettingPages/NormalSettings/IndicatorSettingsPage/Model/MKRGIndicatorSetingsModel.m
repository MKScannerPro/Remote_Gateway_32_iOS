...
@interface MKRGIndicatorSetingsModel ()
...
@implementation MKRGIndicatorSetingsModel
...
- (BOOL)readIndicatorLightStatus {
    ...
    [MKRGMQTTInterface rg_readIndicatorLightStatusWithMacAddress:[MKRGDeviceModeManager shared].macAddress topic:[MKRGDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configIndicatorLightStatus {
    __block BOOL success = NO;
    [MKRGMQTTInterface rg_configIndicatorLightStatus:self macAddress:[MKRGDeviceModeManager shared].macAddress topic:[MKRGDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
