...
@interface MKRGNetworkStatusController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKRGNetworkStatusModel *dataModel;

@end

@implementation MKRGNetworkStatusController

- (void)dealloc {
    NSLog(@"MKRGNetworkStatusController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKRemoteGateway", @"MKRGNetworkStatusController", @"rg_saveIcon.png") forState:UIControlStateNormal];
...
- (MKRGNetworkStatusModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKRGNetworkStatusModel alloc] init];
    }
    return _dataModel;
}
