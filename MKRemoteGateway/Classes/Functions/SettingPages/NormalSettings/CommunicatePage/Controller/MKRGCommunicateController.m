...
@interface MKRGCommunicateController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKRGCommunicateModel *dataModel;

@end

@implementation MKRGCommunicateController

- (void)dealloc {
    NSLog(@"MKRGCommunicateController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKRemoteGateway", @"MKRGCommunicateController", @"rg_saveIcon.png") forState:UIControlStateNormal];
...
- (MKRGCommunicateModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKRGCommunicateModel alloc] init];
    }
    return _dataModel;
}
