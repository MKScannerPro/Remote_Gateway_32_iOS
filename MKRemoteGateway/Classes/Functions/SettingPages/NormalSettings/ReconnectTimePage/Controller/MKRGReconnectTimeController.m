...
@interface MKRGReconnectTimeController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKRGReconnectTimeModel *dataModel;

@end

@implementation MKRGReconnectTimeController

- (void)dealloc {
    NSLog(@"MKRGReconnectTimeController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKRemoteGateway", @"MKRGReconnectTimeController", @"rg_saveIcon.png") forState:UIControlStateNormal];
...
- (MKRGReconnectTimeModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKRGReconnectTimeModel alloc] init];
    }
    return _dataModel;
}
