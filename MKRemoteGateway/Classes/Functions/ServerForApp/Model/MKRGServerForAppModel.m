...
@implementation MKRGServerForAppModel
...
- (void)updateValue:(MKRGServerForAppModel *)model {
    if (!model || ![model isKindOfClass:MKRGServerForAppModel.class]) {
        return;
    }
...
- (void)loadServerParams {
    ...
    self.port = [MKRGMQTTDataManager shared].serverParams.port;
    self.clientID = [MKRGMQTTDataManager shared].serverParams.clientID;
    self.subscribeTopic = [MKRGMQTTDataManager shared].serverParams.subscribeTopic;
    self.publishTopic = [MKRGMQTTDataManager shared].serverParams.publishTopic;
    self.cleanSession = [MKRGMQTTDataManager shared].serverParams.cleanSession;
    
    self.qos = [MKRGMQTTDataManager shared].serverParams.qos;
    self.keepAlive = [MKRGMQTTDataManager shared].serverParams.keepAlive;
    self.userName = [MKRGMQTTDataManager shared].serverParams.userName;
    self.password = [MKRGMQTTDataManager shared].serverParams.password;
    self.sslIsOn = [MKRGMQTTDataManager shared].serverParams.sslIsOn;
    self.certificate = [MKRGMQTTDataManager shared].serverParams.certificate;
    self.caFileName = [MKRGMQTTDataManager shared].serverParams.caFileName;
    self.clientFileName = [MKRGMQTTDataManager shared].serverParams.clientFileName;
}
