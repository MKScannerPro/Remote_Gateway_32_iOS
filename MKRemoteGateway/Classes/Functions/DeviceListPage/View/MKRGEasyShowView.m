...
@implementation MKRGEasyShowView
...
- (UIImageView *)refreshIcon {
    if (!_refreshIcon) {
        ...
        _refreshIcon.image = LOADICON(@"MKRemoteGateway", @"MKRGEasyShowView", @"rg_refreshIcon.png");
    }
    return _refreshIcon;
}
