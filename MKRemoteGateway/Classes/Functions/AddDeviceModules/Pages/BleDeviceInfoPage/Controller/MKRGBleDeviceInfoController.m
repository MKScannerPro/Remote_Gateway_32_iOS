...
@interface MKRGBleDeviceInfoController ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKRGBleDeviceInfoModel *dataModel;

@end

@implementation MKRGBleDeviceInfoController
...
- (MKRGBleDeviceInfoModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKRGBleDeviceInfoModel alloc] init];
    }
    return _dataModel;
}
