//
//  MKRGConnectSuccessController.m
...
@interface MKRGConnectSuccessController ()
...
@implementation MKRGConnectSuccessController

- (void)dealloc {
    NSLog(@"MKRGConnectSuccessController销毁");
}
...
- (void)saveButtonPressed {
    ...
    [MKRGDeviceDatabaseManager insertDeviceList:@[self.deviceModel] sucBlock:^{
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_rg_addNewDeviceSuccessNotification"
                                                            object:nil
