//
//  MKRGServerConfigDeviceFooterView.h
...
@interface MKRGServerConfigDeviceFooterViewModel : NSObject
...
@protocol MKRGServerConfigDeviceFooterViewDelegate <NSObject>
...
@interface MKRGServerConfigDeviceFooterView : UIView

@property (nonatomic, strong)MKRGServerConfigDeviceFooterViewModel *dataModel;

@property (nonatomic, weak)id <MKRGServerConfigDeviceFooterViewDelegate>delegate;
