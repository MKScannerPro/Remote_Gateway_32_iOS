...
@interface MKRGServerForDeviceModel ()
...
@implementation MKRGServerForDeviceModel
...
- (void)updateValue:(MKRGServerForDeviceModel *)model {
    if (!model || ![model isKindOfClass:MKRGServerForDeviceModel.class]) {
        return;
    }
...
- (BOOL)readDeviceMac {
    ...
    [MKRGInterface rg_readDeviceWifiSTAMacAddressWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readDeviceName {
    __block BOOL success = NO;
    [MKRGInterface rg_readDeviceNameWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readHost {
    __block BOOL success = NO;
    [MKRGInterface rg_readServerHostWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configHost {
    __block BOOL success = NO;
    [MKRGInterface rg_configServerHost:self.host sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readPort {
    __block BOOL success = NO;
    [MKRGInterface rg_readServerPortWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configPort {
    __block BOOL success = NO;
    [MKRGInterface rg_configServerPort:[self.port integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readClientID {
    __block BOOL success = NO;
    [MKRGInterface rg_readClientIDWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configClientID {
    __block BOOL success = NO;
    [MKRGInterface rg_configClientID:self.clientID sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readUsername {
    __block BOOL success = NO;
    [MKRGInterface rg_readServerUserNameWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configUserName {
    __block BOOL success = NO;
    [MKRGInterface rg_configServerUserName:self.userName sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readPassword {
    __block BOOL success = NO;
    [MKRGInterface rg_readServerPasswordWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configPassword {
    __block BOOL success = NO;
    [MKRGInterface rg_configServerPassword:self.password sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readCleanSession {
    __block BOOL success = NO;
    [MKRGInterface rg_readServerCleanSessionWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configCleanSession {
    __block BOOL success = NO;
    [MKRGInterface rg_configServerCleanSession:self.cleanSession sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readKeepAlive {
    __block BOOL success = NO;
    [MKRGInterface rg_readServerKeepAliveWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configKeepAlive {
    __block BOOL success = NO;
    [MKRGInterface rg_configServerKeepAlive:[self.keepAlive integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readQos {
    __block BOOL success = NO;
    [MKRGInterface rg_readServerQosWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configQos {
    __block BOOL success = NO;
    [MKRGInterface rg_configServerQos:self.qos sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readSubscribe {
    __block BOOL success = NO;
    [MKRGInterface rg_readSubscibeTopicWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configSubscribe {
    ...
    [MKRGInterface rg_configSubscibeTopic:topic sucBlock:^{
        success = YES;
...
- (BOOL)readPublish {
    __block BOOL success = NO;
    [MKRGInterface rg_readPublishTopicWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configPublish {
    ...
    [MKRGInterface rg_configPublishTopic:topic sucBlock:^{
        success = YES;
...
- (BOOL)readLWTStatus {
    __block BOOL success = NO;
    [MKRGInterface rg_readLWTStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configLWTStatus {
    __block BOOL success = NO;
    [MKRGInterface rg_configLWTStatus:self.lwtStatus sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readLWTQos {
    __block BOOL success = NO;
    [MKRGInterface rg_readLWTQosWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configLWTQos {
    __block BOOL success = NO;
    [MKRGInterface rg_configLWTQos:self.lwtQos sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readLWTRetain {
    __block BOOL success = NO;
    [MKRGInterface rg_readLWTRetainWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configLWTRetain {
    __block BOOL success = NO;
    [MKRGInterface rg_configLWTRetain:self.lwtRetain sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readLWTTopic {
    __block BOOL success = NO;
    [MKRGInterface rg_readLWTTopicWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configLWTTopic {
    ...
    [MKRGInterface rg_configLWTTopic:topic sucBlock:^{
        success = YES;
        self.lwtTopic = topic;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
...
- (BOOL)readLWTPayload {
    __block BOOL success = NO;
    [MKRGInterface rg_readLWTPayloadWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configLWTPayload {
    __block BOOL success = NO;
    [MKRGInterface rg_configLWTPayload:self.lwtPayload sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readSSLStatus {
    __block BOOL success = NO;
    [MKRGInterface rg_readConnectModeWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configSSLStatus {
    __block BOOL success = NO;
    mk_rg_connectMode mode = mk_rg_connectMode_TCP;
    if (self.sslIsOn) {
        if (self.certificate == 0) {
            mode = mk_rg_connectMode_CASignedServerCertificate;
        }else if (self.certificate == 1) {
            mode = mk_rg_connectMode_CACertificate;
        }else if (self.certificate == 2) {
            mode = mk_rg_connectMode_SelfSignedCertificates;
        }
    }
    [MKRGInterface rg_configConnectMode:mode sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configCAFile {
    ...
    [MKRGInterface rg_configCAFile:caData sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configClientKey {
    ...
    [MKRGInterface rg_configClientPrivateKey:clientKeyData sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configClientCert {
    ...
    [MKRGInterface rg_configClientCert:clientCertData sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
