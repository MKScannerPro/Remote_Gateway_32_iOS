//
//  MKRGBleScannerFilterController.m
...
@interface MKRGBleScannerFilterController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKRGBleScannerFilterModel *dataModel;

@end

@implementation MKRGBleScannerFilterController

- (void)dealloc {
    NSLog(@"MKRGBleScannerFilterController销毁");
}
...
- (void)mk_rg_filterNormalTextFieldValueChanged:(NSString *)text index:(NSInteger)index {
    ...
    if (index == 1) {
        ...
        MKRGFilterNormalTextFieldCellModel *cellModel = self.section1List[1];
        cellModel.textFieldValue = text;
        return;
    }
}
...
- (void)loadSection1Datas {
    MKRGFilterNormalTextFieldCellModel *cellModel1 = [[MKRGFilterNormalTextFieldCellModel alloc] init];
    cellModel1.index = 0;
    ...
    MKRGFilterNormalTextFieldCellModel *cellModel2 = [[MKRGFilterNormalTextFieldCellModel alloc] init];
    cellModel2.index = 1;
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKRemoteGateway", @"MKRGBleScannerFilterController", @"rg_saveIcon.png") forState:UIControlStateNormal];
...
- (MKRGBleScannerFilterModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKRGBleScannerFilterModel alloc] init];
    }
    return _dataModel;
}
