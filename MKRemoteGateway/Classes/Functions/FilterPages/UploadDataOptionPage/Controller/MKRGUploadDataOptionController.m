//
//  MKRGUploadDataOptionController.m
...
@interface MKRGUploadDataOptionController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKRGUploadDataOptionModel *dataModel;

@end

@implementation MKRGUploadDataOptionController

- (void)dealloc {
    NSLog(@"MKRGUploadDataOptionController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKRemoteGateway", @"MKRGUploadDataOptionController", @"rg_saveIcon.png") forState:UIControlStateNormal];
...
- (MKRGUploadDataOptionModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKRGUploadDataOptionModel alloc] init];
    }
    return _dataModel;
}
