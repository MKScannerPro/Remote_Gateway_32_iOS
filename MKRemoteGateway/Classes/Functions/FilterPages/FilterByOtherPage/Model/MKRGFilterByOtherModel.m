...
@implementation MKRGFilterRawAdvDataModel
...
@interface MKRGFilterByOtherModel ()
...
@implementation MKRGFilterByOtherModel
...
- (BOOL)readFilterByOther {
    ...
    [MKRGMQTTInterface rg_readFilterOtherDatasWithMacAddress:[MKRGDeviceModeManager shared].macAddress topic:[MKRGDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configFilterByOther:(NSArray <MKRGFilterRawAdvDataModel *>*)list relationship:(mk_rg_filterByOther)relationship {
    __block BOOL success = NO;
    [MKRGMQTTInterface rg_configFilterByOtherDatas:self.isOn relationship:relationship rawDataList:list macAddress:[MKRGDeviceModeManager shared].macAddress topic:[MKRGDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
