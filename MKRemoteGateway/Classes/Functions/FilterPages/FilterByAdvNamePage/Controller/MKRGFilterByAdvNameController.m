//
//  MKRGFilterByAdvNameController.m
...
@property (nonatomic, strong)MKRGFilterByAdvNameModel *dataModel;

@end

@implementation MKRGFilterByAdvNameController
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKRemoteGateway", @"MKRGFilterByAdvNameController", @"rg_saveIcon.png") forState:UIControlStateNormal];
...
- (MKRGFilterByAdvNameModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKRGFilterByAdvNameModel alloc] init];
    }
    return _dataModel;
}
