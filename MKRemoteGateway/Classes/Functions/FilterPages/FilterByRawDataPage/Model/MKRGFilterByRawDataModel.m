...
@interface MKRGFilterByRawDataModel ()
...
@implementation MKRGFilterByRawDataModel
...
- (BOOL)readFilterByRawData {
    ...
    [MKRGMQTTInterface rg_readFilterByRawDataStatusWithMacAddress:[MKRGDeviceModeManager shared].macAddress topic:[MKRGDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
