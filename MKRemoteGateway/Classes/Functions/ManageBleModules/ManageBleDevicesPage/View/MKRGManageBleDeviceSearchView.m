//
//  MKRGManageBleDeviceSearchView.m
...
@interface MKRGManageBleDeviceSearchView ()<UIGestureRecognizerDelegate>
...
@implementation MKRGManageBleDeviceSearchView

- (void)dealloc{
    NSLog(@"MKRGManageBleDeviceSearchView销毁");
}
...
+ (void)showSearchName:(NSString *)name
    ...
    MKRGManageBleDeviceSearchView *view = [[MKRGManageBleDeviceSearchView alloc] init];
...
- (UIImageView *)signalIcon{
    if (!_signalIcon) {
        _signalIcon = [[UIImageView alloc] initWithFrame:CGRectMake(offset_X,
                                                                    ...
                                                                    signalIconWidth,
                                                                    signalIconHeight)];
        _signalIcon.image = LOADICON(@"MKRemoteGateway", @"MKRGManageBleDeviceSearchView", @"rg_wifiSignalIcon.png");
    }
    return _signalIcon;
}
...
- (UIImageView *)graySignalIcon {
    if (!_graySignalIcon) {
        _graySignalIcon = [[UIImageView alloc] initWithFrame:CGRectMake(backViewWidth - offset_X - signalIconWidth,
                                                                    ...
                                                                    signalIconWidth,
                                                                    signalIconHeight)];
        _graySignalIcon.image = LOADICON(@"MKRemoteGateway", @"MKRGManageBleDeviceSearchView", @"rg_wifiGraySignalIcon.png");
    }
