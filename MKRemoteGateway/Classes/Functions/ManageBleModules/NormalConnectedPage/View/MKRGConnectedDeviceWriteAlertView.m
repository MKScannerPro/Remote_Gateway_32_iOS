//
//  MKRGConnectedDeviceWriteAlertView.m
...
@interface MKRGConnectedDeviceWriteAlertView ()
...
@implementation MKRGConnectedDeviceWriteAlertView

- (void)dealloc {
    NSLog(@"MKRGConnectedDeviceWriteAlertView销毁");
}
