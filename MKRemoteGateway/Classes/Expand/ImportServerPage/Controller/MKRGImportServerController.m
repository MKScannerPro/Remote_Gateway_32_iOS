...
@interface MKRGImportServerController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MKRGImportServerController

- (void)dealloc {
    NSLog(@"MKRGImportServerController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([self.delegate respondsToSelector:@selector(rg_selectedServerParams:)]) {
        [self.delegate rg_selectedServerParams:model.leftMsg];
    }
