...
@implementation MKRGAlertViewModel
@end

@interface MKRGAlertView ()
...
@implementation MKRGAlertView

- (void)dealloc {
    NSLog(@"MKRGAlertView销毁");
}
...
- (void)showWithModel:(MKRGAlertViewModel *)dataModel
    ...
    if (!dataModel || ![dataModel isKindOfClass:MKRGAlertViewModel.class]) {
        return;
    }
